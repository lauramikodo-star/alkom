...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _scanVoucher(TextEditingController controller) async {
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            tabs: [
              ...
              Tab(text: '4G LTE', icon: Icon(Icons.wifi_tethering)),
            ],
          ),
        ),
        body: SafeArea(
                  ...
                  Row(
                    children: [
                      ...
                      IconButton.filledTonal(
                        onPressed: () => _scanVoucher(_voucherCtrl),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      IconButton.filledTonal(
                        onPressed: () => _scanVoucher(_4gVoucherCtrl),
                        icon: const Icon(Icons.camera_alt),
                        tooltip: 'Scan Voucher',
                      )
                    ],
